...
if __name__ == "__main__":
    ...
    classes = ['BananaPeel', 'BrokenBones', 'CigaretteEnd', 'DisposableChopsticks', 'Ketchup', 'Marker', 'OralLiquidBottle',
               'Plate', 'PlasticBottle', 'StorageBattery', 'Toothbrush', 'Umbrella']
    # a YoLov5TRT instance
    yolov5_wrapper = YoLov5TRT('./garbage_classification_320s_6_2.engine', './libmyplugins_320.so', classes)
    try:
        while True:
            t = time.time()
            ret, frame = cap.read()
